...
// text-glow, a sub-line in fg-subtle, and a 46px gradient tile on the right.
// These three are process, which is exactly why they are allowed to glow —
// no money value on this page gets the same treatment.
function Tile({
  label,
  value,
  sub,
  ...
  return (
    <div className="card-surface edge-neon flex items-center justify-between gap-3 px-5 py-[18px]">
